...
import { Calendar, MapIcon, BotIcon, UsersIcon, ShieldIcon, LineChart } from 'lucide-react';
        ...
        <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-5xl">
                <div className="text-center mb-16">
                    <h2 className="gradient-text mb-4">Maßgeschneiderte KI-Lösungen</h2>
                ...
                <div className="mx-auto grid gap-4 lg:grid-cols-2">
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                ...
                                description="Intelligente Konversationssysteme für Ihre Website und Messaging-Plattformen."
                            />
                        </CardHeader>
                        ...
                        <div className="relative mb-6 border-t border-dashed sm:mb-0">
                            ...
                            <div className="aspect-[76/59] p-1 px-6">
                                <DualModeImage
                                    darkSrc="https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg"
                                    lightSrc="https://images.pexels.com/photos/8386434/pexels-photo-8386434.jpeg"
                                    alt="KI-Chatbot Schnittstelle"
                                    width={1207}
                                    height={929}
                                />
                            </div>
                    ...
                    <FeatureCard>
                        <CardHeader className="pb-3">
                            <CardHeading
                                icon={LineChart}
                                title="Datenanalyse & -optimierung"
                                description="Automatisierte Auswertung und kontinuierliche Verbesserung Ihrer Kundenkommunikation."
                            />
                        </CardHeader>
                        ...
                        <CardContent>
                            <div className="relative mb-6 sm:mb-0">
                                ...
                                <div className="aspect-[76/59] border">
                                    <DualModeImage
                                        darkSrc="https://images.pexels.com/photos/7567441/pexels-photo-7567441.jpeg"
                                        lightSrc="https://images.pexels.com/photos/7567441/pexels-photo-7567441.jpeg"
                    ...
                    <FeatureCard className="p-6 lg:col-span-2">
                        <p className="mx-auto my-6 max-w-md text-balance text-center text-2xl font-semibold">Unsere Technologie basiert auf modernsten Large Language Models mit benutzerdefinierten Erweiterungen.</p>

                        <div className="flex justify-center gap-6 overflow-hidden pt-4">
                            <CircularUI
                                label="Einfache Integration"
