...
import { Lock, User, AlertCircle, EyeOff, Eye, Bot, Mail } from 'lucide-react';
...
function CustomerLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (email === 'kunde@example.com' && password === 'kunde123') {
      ...
      >
          ...
          <div className="p-6 sm:p-8">
            ...
            <div className="mt-8 text-center">
              <p className="text-xs text-gray-500 dark:text-gray-400">
                ...
                <span className="font-medium">kunde@example.com / kunde123</span> einloggen
              </p>
            </div>
          </div>
        ...
        <div className="mt-4 text-center">
          <div className="flex items-center justify-center gap-2 text-sm text-gray-500 dark:text-gray-400">
            <Bot size={16} />
            <span>KI-Helpbot Kundenportal</span>
          </div>
        </div>
      </motion.div>
    </div>
